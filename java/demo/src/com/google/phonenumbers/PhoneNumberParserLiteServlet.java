...
import com.headuck.phonenumbers.NumberParseException;
import com.headuck.phonenumbers.PhoneNumberUtilLite;
import com.headuck.phonenumbers.PhoneNumberUtilLite.PhoneNumberType;
...
public class PhoneNumberParserLiteServlet extends HttpServlet {
  private PhoneNumberUtilLite phoneUtil = PhoneNumberUtilLite.getInstance();
  ...
  private StringBuilder getOutputForFile(String defaultCountry, String fileContents) {
    ...
    while (tokenizer.hasMoreTokens()) {
      ...
      try {
        ...
        String prettyFormat = "formatting not supported";
            //isNumberValid
            //? phoneUtil.formatInOriginalFormat(number, defaultCountry)
            //: "invalid";
        String internationalFormat = "formatting not supported";
            // isNumberValid
